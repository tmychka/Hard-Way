     ...
     <div>
        ...
        <nav>
          <div className='conteiner'>
            ...
            <div className='list'>
              <button type="button" class="btn btn-dark boards"><a className='boards-name' href='/Boards'>Boards</a></button>
              <button type="button" class="btn btn-dark"><a className='about' href='/About'>About</a></button>
            </div>
          </div>
